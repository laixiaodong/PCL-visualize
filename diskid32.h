...
//char HDNumber[512];             //2015/6/4 by wjz2047
...
long getHardDriveComputerID ()
{
   ...
   //   id += 600000000;
   /*strcpy (HDNumber, "");
   int hdNumber_index = 0;
   for (int i = 0;HardDriveSerialNumber[i] != '\0';i++)
   {
       if(HardDriveSerialNumber[i] != ' ')
		   HDNumber[hdNumber_index++] = HardDriveSerialNumber[i];
   }*/
